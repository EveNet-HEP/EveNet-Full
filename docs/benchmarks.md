# EveNet Downstream Tasks

This page lists all downstream tasks used in **EveNet**, including datasets and code repositories.

Each task is self-contained. For instructions, refer to the README of the corresponding repository.
...
https://github.com/EveNet-HEP/EveNet_Result_Plot  
